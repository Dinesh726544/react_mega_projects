...
export function Sidebar({selectedTab,handleClick}) {
        ...
        <>
            <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark w-[280px] h-screen">
                ...
                <li className="nav-item" onClick={() => {handleClick('Home')}} >
                    ...
                    <svg className="bi pe-none me-2" width="16" height="16"><use xlinkherf="#home"></use></svg>
                    Home
                    </a>
                </li>
                <li className="nav-item" onClick={() => {handleClick('Create Post')}} >
